package com.deeplake.aknidl.util.NBTStrDef;
...
public class IDLNBTDef {
	...
	public static final String NAME_OFF= "aknidl.shared.off";
	public static final String NAME_ON= "aknidl.shared.on";
	...
	//gua socket
	public static final String GUA_NO_FREE_SOCKET_DESC = "aknidl.gua_enhance_no_free.desc";
	public static final String GUA_FREE_SOCKET_DESC = "aknidl.gua_enhance_free.desc";
	public static final String GUA_TOTAL_SOCKET_DESC = "aknidl.gua_enhance_total.desc";
	public static final String GUA_N_A_DESC = "aknidl.gua_not_applicable.desc";
	...
	public static final String KILL_COUNT_DESC = "aknidl.kill_count.desc";
