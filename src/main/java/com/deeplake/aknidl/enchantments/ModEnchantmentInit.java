package com.deeplake.aknidl.enchantments;
...
public class ModEnchantmentInit {
    ...
    //Example Enchant
    public static final ModEnchantmentBase ANTI_VANILLA = new ModEnchantmentBase("aknidl.anti_vanilla", Enchantment.Rarity.UNCOMMON, EnumEnchantmentType.WEAPON,  mainHand)
