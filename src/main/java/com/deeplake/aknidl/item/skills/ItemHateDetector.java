...
import static com.deeplake.aknidl.util.NBTStrDef.IDLNBTDef.STATE;
import static com.deeplake.aknidl.util.NBTStrDef.IDLNBTUtil.GetInt;
import static com.deeplake.aknidl.util.NBTStrDef.IDLNBTUtil.SetInt;

public class ItemHateDetector extends ItemSkillBase {

    private Class<? extends EntityLiving> targetCategory = EntityLiving.class;
    private String msgKey = "aknidl.msg.being_targeted";
