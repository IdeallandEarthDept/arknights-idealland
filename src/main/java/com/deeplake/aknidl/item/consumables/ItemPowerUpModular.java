package com.deeplake.aknidl.item.consumables;

import com.deeplake.aknidl.entity.creatures.EntityModUnit;
import com.deeplake.aknidl.item.ItemBase;
import com.deeplake.aknidl.util.CommonFunctions;
import com.deeplake.aknidl.util.EntityUtil;
...
import static com.deeplake.aknidl.util.NBTStrDef.IDLNBTDef.MARK_TOTAL_COUNT;
    ...
    public boolean itemInteractionForEntity(ItemStack stack, EntityPlayer playerIn, EntityLivingBase target, EnumHand handIn) {
        if (target instanceof EntityModUnit)
        {
            ...
            if (legalTarget.is_mechanic)
            {
                ...
                {
                    CommonFunctions.SafeSendMsgToPlayer(playerIn, "aknidl.msg.upgrade_module.req_lv", String.valueOf(requireLv));
                    return false;
                }
                ...
                if (!playerIn.world.isRemote)
                {
                    ...
                    if (success)
                    {
                        ...
                        CommonFunctions.SafeSendMsgToPlayer(playerIn, "aknidl.msg.upgrade_module.ok", valueBefore, valueAfter);
